...
function timerStatus(remainingMin) {
  ...
  } else if (remainingMin === undefined) {
...
function estimatePrepTime(ingredients, prepTimeIngredient) {
  return prepTimeIngredient !== undefined
    ? ingredients.length * prepTimeIngredient
